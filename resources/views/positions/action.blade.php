<a href="{{ route('admin.positions.edit', ['id' => $row->id]) }}" class="btn btn-xs btn-warning" data-toggle="tooltip" data-placement="top" data-title="Edit">
...
<form method="post" action="{{ route('admin.positions.delete', ['id' => $row->id]) }}" enctype="multipart/form-data">
    @method('delete')
    @csrf
